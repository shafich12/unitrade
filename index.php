    ...
    <section class="small-section small-slider pt-res-0">
        <div class="container">
            <div class="slider-animate home-slider">
                ...
                <div>
                    <div class="home">
                        <img src="assets/images/electronics/home-slider/2.jpg" alt=""
                            class="bg-img blur-up lazyload">
                        <div class="container">
                            <div class="row">
                                <div class="col">
                            ...
                            <div id="tab-4" class="tab-content active default">
                                <div class="no-slider five-product row">
                                    ...
                                    <div class="product-box product-wrap">
                                        <div class="img-wrapper">
                                            <div class="front">
                                                <a href="<?php echo "view/product-details.php?id=".$product['product_id'] ?>"><img src="<?php echo $product['product_image'] ?>"
                                                class="img-fluid blur-up lazyload bg-img"
                                                alt=""></a>
                                            </div>
                                        </div>

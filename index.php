...
if (is_login()) {
    ...
    $school_products = select_all_products_controller();
}
?>
...
<section class="small-section small-slider pt-res-0">
    <div class="container">
        <div class="slider-animate home-slider">
            <div>
                <div class="home">
                    <img src="assets/images/electronics/home-slider/1.jpg" alt="" class="bg-img blur-up lazyload">
                    <div class="container">
                        <div class="row">
                            <div class="col">
            ...
            <div>
                <div class="home">
                    <img src="assets/images/electronics/home-slider/2.jpg" alt="" class="bg-img blur-up lazyload">
                    <div class="container">
                        <div class="row">
                            <div class="col">
                                <div class="slider-contain px-padding">
            ...
            <div class="row margin-default">
                <div class="col-xl-3 col-sm-6 service-block">
                    <div class="media">
                        ...
                        <div class="media-body">
                            <h4>Nationwide Deliveries</h4>
                            <p>door-to-door deliveries available
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-3 col-sm-6 service-block">
                    <div class="media">
                        ...
                        <div class="media-body">
                            <h4>New offers</h4>
                            <p>new offers available daily!</p>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-sm-6 service-block">
                ...
                ?>
                    ...
                    <div class="product-box product-wrap">
                        <div class="img-wrapper">
                            <div class="front">
                                <a href="<?php echo "view/product-details.php?id=" . $key['product_id'] ?>"><img src="<?php echo $key['product_image'] ?>" class="img-fluid blur-up lazyload bg-img" alt=""></a>
                            </div>
                        </div>
                        <div class="product-detail">
                            <div style="text-align:center;">
                                ...
                                <?php if (isset($_SESSION['user_id'])) { ?>
                                    <?php if ($key['product_owner'] != $_SESSION['user_id']) { ?>
                            ...
                            <a href="view/category.php">
                                <div class="collection-banner tl-content">
                                    <div class="img-part custom-height">
                                        <img src="assets/images/electronics/banner/13.jpg" class="img-fluid blur-up lazyload bg-img" alt="">
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-12 mb-4">
                                        <a href="view/category.php">
                                            <div class="collection-banner">
                                                <div class="img-part">
                                                    <img src="assets/images/electronics/banner/15.jpg" class="img-fluid blur-up lazyload bg-img" alt="">
                                                </div>
                                                <div class="contain-banner banner-3">
                                                    <div>
                                                        <h2>laptops</h2>
                                    ...
                                    <div class="col-12">
                                        <a href="view/category.php">
                                            <div class="collection-banner">
                                                <div class="img-part">
                                                    <img src="assets/images/electronics/banner/14.jpg" class="img-fluid blur-up lazyload bg-img" alt="">
                                                </div>
                                                <div class="contain-banner banner-3">
                                                    <div>
                                                        <h2>phones</h2>
                    ...
                    <div class="col-lg-3 col-12 d-lg-block d-none">
                        <div class="banner-goggles banner-padding pt-0">
                            <a href="view/category.php">
                                <div class="collection-banner tl-content">
                                    <div class="img-part custom-height">
                                        <img src="assets/images/electronics/banner/16.jpg" class="img-fluid blur-up lazyload bg-img" alt="">
                                    </div>
                                    <div class="contain-banner banner-3">
                                        <div>
                                            <h2>clothing</h2>
                    ...
                    <div class="theme-tab">
                        <div class="bg-title-part mt-0">
                            <div class="title-basic mb-0">
                                <h2 class="title">Offers from your school</h2>
                            </div>
                        ...
                        <div class="tab-content-cls">
                            <div id="tab-4" class="tab-content active default">
                                <div class="no-slider five-product row">
                                    <?php if ($school_products) { ?>
                                        <?php foreach ($school_products as $product) { ?>
                                            <div class="product-box product-wrap">
                                                <div class="img-wrapper">
                                                    <div class="front">
                                                        <a href="<?php echo "view/product-details.php?id=" . $product['product_id'] ?>"><img src="<?php echo $product['product_image'] ?>" class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                                    </div>
                                                </div>
                                                <div class="product-detail">
                                                    <div style="text-align:center;">
                                                        <a href="<?php echo "view/product-details.php?id=" . $product['product_id'] ?>">
                                        ...
                                        ?>
                                        <h5>No Offers From Your School</h5>
                                </div>
                            <?php } ?>
                            </div>
                        </div>

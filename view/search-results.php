                                                ...
                                                <div class="col-xl-3 col-6 col-grid-box">
                                                    <div class="product-box">
                                                        <div class="img-wrapper">
                                                            <div class="front">
                                                                <a href="<?php echo "product-details.php?id=".$result['product_id'] ?>"><img src="<?php echo "../".$result['product_image'] ?>"
                                                        ...
                                                        <div class="product-detail">
                                                            <div style="text-align:center;">
                                                                ...
                                                                <a href="<?php echo "product-details.php?id=".$result['product_id'] ?>"><h5><?php echo "GHS ".number_format($result['product_price'], 2, '.', '') ?></h5></a>
